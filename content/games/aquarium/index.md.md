...
resources:
- name: wacky
  src: wackyquarium.PNG
sidebar:
  exclude: true
---

_"Wacky-quarium is a city builder where you start out building an aquascape to attract beneficial alien sea creatures...but the sea creatures might have a mind of their own."_

{{< cards cols="2" >}}
  {{< card title="Role: Lead Developer" subtitle="Intending to release for PC using Unreal Engine" >}}
  {{< card image="wacky" subtitle="Ugly dev build">}}
{{< /cards >}}
